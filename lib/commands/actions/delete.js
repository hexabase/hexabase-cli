...
class ActionsDelete extends base_with_context_1.default {
    constructor() {
        super(...arguments);
        this.questions = [
            {
    ...
    async run() {
        ...
        if (flags.yes) {
            ...
            this.log(`You are about to delete the action with id: ${chalk_1.default.cyan(args.action_id)}`);
...
exports.default = ActionsDelete;
ActionsDelete.description = 'delete an action in a datastore';
ActionsDelete.flags = Object.assign(Object.assign({}, base_with_context_1.default.flags), { help: command_1.flags.help({ char: 'h' }), yes: command_1.flags.boolean({ char: 'y', description: 'skip confirmation' }) });
ActionsDelete.args = [
    {
        name: 'datastore_id',
